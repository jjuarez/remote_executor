...
directory into the file ${HOME}/.remoteexecutorrc like this:
  ...
  :production:
    - :name: 'myFarm'
      :hosts: 
        - 'myHost1'
        - 'myHost2.sshconfigalias'
        - 'myHost3.sshconfigalias'
        - 'myHost4.sshconfigalias'
        - 'myHost5.sshconfigalias'
        - 'myHost6.sshconfigalias'
        - 'myHost7.sshconfigalias'
        - 'myHost8.sshconfigalias'

you need this minimal SSH configuration (${HOME}/.ssh/config) for the example

  Host myHost1
    HostName fqdn.myhost1
    User admin
